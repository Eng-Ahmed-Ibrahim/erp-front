...
const ShowRecipe = () => {
  ...
  const tableHeaders = [
    ...
    { key: 'quantity', value: '   الكميه (المخزن الرئيسي) ', type: 'text' },
  ];
  ...
  const actions = [
    ...
    },
    {
      ...
      disabled: (item) => !item.has_products,
      className: (item) => (!item.has_products ? 'disabled-button' : ''),
    },
