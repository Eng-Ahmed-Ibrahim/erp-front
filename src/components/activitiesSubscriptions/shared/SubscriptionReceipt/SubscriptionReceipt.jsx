      ...
      <div ref={componentRef} className="receipt-paper" dir="rtl">
        ...
        <div className="codes-section">
          ...
          <div className="footer-text">
            ...
            نأسف في حاله عدم الحضور او حضور حصه واحدة لن يتم استرداد المبلغ والمتعلقات الشخصيه مسئوليه صاحبها.

              مسئوليه ولي الامر الكشف الطبى على اللاعب ويكون لائق طبياً قبل ممارسه النشاط دون ادنى مسئوليه علي الدار
            </p>
          </div>
        </div>
      </div>
